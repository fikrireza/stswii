...
class AgentController extends Controller
{
	...
	function update(Request $request){
		...
		if($validator->fails())
		{
			return redirect()->route('agent.index.table.php')->withErrors($validator)->withInput()->with('update-false', 'Something Errors');
		}
		...
		{
			return redirect()->route('agent.index.table.php')->with('update-false', 'Your data already updated by ' . $index->updatedBy->name . '.');
		}
		...
		return redirect()->route('agent.index.table.php')->with('berhasil', 'Your data has been successfully updated.');
	}
