...
class PartnerPulsaController extends Controller
{
    ...
    public function index()
    {
    	...
    	return view('partner-pulsa.index', compact('getPartnerPulsa'));
    }
    ...
    public function store(Request $request)
    {
      $message = [
  		...
  		return redirect()->route('partner-pulsa.index')->with('berhasil', 'Berhasil Menambahkan Provider '.$request->partner_pulsa_name);
    }

    public function edit($id)
    {

    	return view('partner-pulsa.ubah', compact('id'));
    }
